package com.spitchenko.appsgeyser.utils.parser;
...
public final class XmlParser {
	...
	public XmlParser(@NonNull final String input) throws IOException, XmlPullParserException {
	...
	private Tag readTags() throws IOException, XmlPullParserException {
        Tag parent = null;
        Tag nextTag = null;
        int depth = 0;
    ...
    private Tag getCurrentTagByParent(@NonNull final String inputTag, @NonNull final Tag tag) {
    ...
    private String getValueTag(@NonNull final String inputTag, @NonNull final String parentTag
	...
	private InputStream getInputStream(@NonNull final String input) {
        return new ByteArrayInputStream(input.getBytes(Charset.defaultCharset()));
	}

	public String getLanguage() throws IOException, XmlPullParserException {
        final Tag root = readTags();
        return getValueTag(LANGUAGE_TAG, RESULTS_TAG, root);
    }
}
